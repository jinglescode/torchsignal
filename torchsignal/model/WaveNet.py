"""
This is an implementation of the WaveNet architecture, as described in the original paper, WaveNet: A Generative Model for Raw Audio, https://arxiv.org/abs/1609.03499.
Taken from https://github.com/vincentherrmann/pytorch-wavenet.
Adapted for PyTorch 1.6.
"""

###################################
# https://github.com/vincentherrmann/pytorch-wavenet/blob/master/wavenet_modules.py
